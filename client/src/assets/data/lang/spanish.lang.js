...
const spanish = [
  {
    ...
    about: {
      ...
      description:
        "¡Bienvenido a TODOVISA! Somos una empresa dedicada a abrir puertas a incontables oportunidades de crecimiento, aventura e innovación. En nuestra comunidad, fomentamos la creatividad y la realización de sueños.",
      description02:
        "Nos esforzamos por derribar barreras y redefinir el concepto de éxito. Con pasión y compromiso, guiamos a nuestros clientes en un emocionante viaje hacia un futuro más brillante, donde cada paso te acerque a alcanzar tu máximo potencial. Descubre cómo podemos ayudarte a hacer realidad tus sueños.",
      ...
      countries: {
        usa: {
          name: "Estados Unidos",
          description:
            "País de América del Norte conocido por su diversidad cultural, economía poderosa y liderazgo global en política y tecnología.",
        ...
        canada: {
          name: "Canadá",
          description:
            "País en América del Norte famoso por sus paisajes naturales vastos, multiculturalismo y alta calidad de vida.",
        ...
        mexico: {
          name: "México",
          description:
            "País en América del Norte rico en cultura, historia, playas paradisíacas y vida urbana vibrante.",
        ...
        uk: {
          name: "Inglaterra",
          description:
            "Parte del Reino Unido famosa por su historia rica, contribuciones a la literatura y ciencia, y su monarquía.",
        ...
        china: {
          name: "China",
          description:
            "País en Asia conocido por su antigua civilización, avances tecnológicos y económicos, y maravillas como la Gran Muralla y la Ciudad Prohibida.",
        ...
        australia: {
          name: "Australia",
          description:
            "País en Oceanía famoso por su fauna única, paisajes naturales impresionantes como la Gran Barrera de Coral, y un estilo de vida relajado.",
        ...
        india: {
          name: "India",
          description:
            "País en Asia del Sur conocido por su diversidad cultural, riqueza histórica y espiritualidad, hogar de monumentos como el Taj Mahal.",
    ...
    VIPRO: {
      ...
      strong:
        "Al completar el formulario, recibirás un 25% de descuento en el siguiente paso de la asesoría para la visa con",
    ...
    form: {
      ...
      title: "Preformulario de Probabilidad de Visado (VIPRO)",
      description:
        "Este es el preformulario de Probabilidad de Visado (VIPRO), diseñado para evaluar tus posibilidades de obtener una visa en base a tu perfil personal. Te pedimos que completes todos los campos con la información más precisa y actualizada posible. Esto nos permitirá proporcionarte una evaluación preliminar eficiente y rápida, y ayudarte a entender mejor tus opciones antes de proceder con la solicitud formal.",
      acept: "Acepto los ",
      ...
      button2: "Cancelar!",
      warning:
        "Debes aceptar los términos y condiciones antes de guardar el formulario.",
      alert_save: "Seguro que quieres guardar",
      obligatory_field:
        "Este campo es obligatorio. Por favor, ingresa un valor.",
      select_option: "Selecciona una opción",
      save: "Guardando formulario",
      wait: "Por favor espera...",
      wait_title: "Validando datos",
      error_save:
        "Ocurrió un error al guardar el formulario. Inténtalo de nuevo.",
      ...
      send_error:
        "Ocurrió un error al enviar el formulario. Inténtalo de nuevo más tarde.",
    },
    with_session: {
      title: "Ya tienes una sesion iniciada",
      subtitle:
        "Cierra sesión para registrarte o iniciar sesión con otro usuario.",
    ...
    forgot_password: {
      ...
      description:
        "No te preocupes, nos pasa a todos. Ingrese su correo electrónico a continuación para recuperar su contraseña",
      email: "Correo electrónico",
    ...
    mexico: {
      first_section: {
        introduccion:
          "Viajar a México es una experiencia enriquecedora y atractiva por diversas razones que incluyen su riqueza cultural, sus impresionantes sitios turísticos y su hospitalidad. Aquí se detallan algunos de los principales motivos por los que las personas eligen México como destino de viaje:",
        secciones: [
          {
            titulo: "Riqueza Cultural",
            descripcion:
              "México es conocido por su rica herencia cultural, la cual se refleja en sus festivales, tradiciones, gastronomía y arte.",
            tarjetas: [
              {
          ...
          },
          {
            ...
            descripcion:
              "México es hogar de numerosos sitios arqueológicos que atraen a turistas de todo el mundo.",
            tarjetas: [
              {
          ...
          },
          {
            ...
            descripcion:
              "México ofrece una amplia variedad de destinos turísticos que satisfacen diferentes intereses, desde playas hasta ciudades coloniales.",
            tarjetas: [
              {
          ...
          },
          {
            ...
            descripcion:
              "México ofrece una gran diversidad de paisajes naturales, desde desiertos hasta selvas tropicales.",
            tarjetas: [
              {
                imagen: "mexico/barrancas.jpg",
                titulo: "Barrancas del Cobre",
                descripcion:
                  "Situadas en el estado de Chihuahua, estas impresionantes formaciones geológicas son ideales para el ecoturismo y las actividades al aire libre.",
              },
              {
                imagen: "mexico/xearet.webp",
                titulo: "Xcaret y Xel-Há",
                descripcion:
                  "Parques ecológicos en la Riviera Maya que combinan atracciones naturales con actividades culturales y recreativas.",
              },
              {
                imagen: "mexico/sierra_gorda.jpeg",
                titulo: "Sierra Gorda de Querétaro",
                descripcion:
                  "Una región con una biodiversidad excepcional, ideal para el ecoturismo y la observación de flora y fauna.",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            descripcion:
              "A partir de 2024, los ciudadanos de los siguientes países de América Latina necesitan una visa para ingresar a México:",
            lista: [
              "Antigua y Barbuda",
              "Brasil",
              "Cuba",
              ...
              items: [
                ...
                },
                {
                  ...
                  subitems: [
                    ...
                    {
                      title:
                        "B. Por Solvencia Económica - Por Empleo, Cuenta Bancaria o Depósitos a Plazo:",
                      options: [
                        {
                          title: "Por Empleo",
                        ...
                        {
                          title:
                            "Opción 3: Depósitos a Plazo o Títulos Valores y Acciones.",
                          details: [
                    ...
                    {
                      title:
                        "D. Por Invitación de una Organización o de una Institución Pública o Privada:",
                      details: [
                    ...
                    },
                    {
                      ...
                      details: [
                        "Si el solicitante de visa de turista que sea mayor de 65 años, y que acredite fehacientemente, a juicio de la autoridad migratoria, tener como propósito visitar territorio nacional con fines turísticos, no será necesario acreditar la solvencia económica.",
                      ],
                    },
                    {
                      title: "F. Viajero Frecuente:",
                      details: [
                        "Mostrar copia de las páginas del pasaporte con tres visas vigentes o sellos de control migratorio de países no limítrofes, visitados en los últimos 12 meses.",
                      ],
                    },
                    {
    ...
    canada: {
      first_section: {
        introduccion:
          "Canadá es conocido por su alta calidad de vida, su sistema de salud universal y su paisaje natural impresionante. Ofrece oportunidades únicas para estudiantes, profesionales y turistas.",
        secciones: [
          {
            titulo: "Oportunidades de Estudio",
            descripcion:
              "Canadá es un destino muy popular para estudiantes internacionales debido a sus instituciones educativas de alta calidad y a su entorno multicultural.",
            tarjetas: [
              {
                imagen: "canada/universidad_canada.jpg",
                titulo: "Universidades de Prestigio",
                descripcion:
                  "Canadá alberga algunas de las universidades más prestigiosas del mundo, ofreciendo una variedad de programas académicos.",
              },
              {
                imagen: "canada/becas_canada.jpg",
                titulo: "Becas y Ayudas",
                descripcion:
                  "Existen numerosas becas y ayudas para estudiantes internacionales, facilitando el acceso a la educación superior.",
              },
              {
                imagen: "canada/estudiantil_canada.jpeg",
                titulo: "Vida Estudiantil",
                descripcion:
                  "La vida estudiantil en Canadá es vibrante y diversa, con numerosas actividades extracurriculares y oportunidades de socialización.",
              },
            ],
          },
          {
            ...
            descripcion:
              "Canadá es conocido por su alta calidad de vida, con un sistema de salud robusto y un entorno seguro para sus residentes.",
            tarjetas: [
              {
                imagen: "canada/salud_canada.jpg",
                titulo: "Sistema de Salud",
                descripcion:
                  "El sistema de salud canadiense es uno de los mejores del mundo, proporcionando acceso a atención médica universal.",
              },
              {
                imagen: "canada/seguridad_canada.jpg",
                titulo: "Seguridad",
                descripcion:
                  "Canadá es uno de los países más seguros del mundo, con bajos índices de criminalidad y un entorno pacífico.",
              },
              {
                imagen: "canada/costo_canada.jpg",
                titulo: "Costo de Vida",
                descripcion:
                  "Aunque el costo de vida puede variar, Canadá ofrece un buen equilibrio entre calidad de vida y gasto económico.",
              },
            ],
          },
          {
            ...
            descripcion:
              "Canadá es famoso por su belleza natural, desde las Montañas Rocosas hasta los Grandes Lagos y los parques nacionales.",
            tarjetas: [
              {
                imagen: "canada/rocosas_canada.jpg",
                titulo: "Montañas Rocosas",
                descripcion:
                  "Un destino popular para el senderismo, el esquí y otras actividades al aire libre.",
              },
              {
                imagen: "canada/cataratas_canada.jpg",
                titulo: "Cataratas del Niágara",
                descripcion:
                  "Una de las maravillas naturales más famosas del mundo, conocida por su impresionante caída de agua.",
              },
              {
                imagen: "canada/parque_canada.jpg",
                titulo: "Parques Nacionales",
                descripcion:
                  "Canadá cuenta con numerosos parques nacionales que ofrecen vistas impresionantes y actividades recreativas.",
              },
            ],
          },
          {
            ...
            descripcion:
              "Canadá ofrece múltiples oportunidades de empleo e inmigración para profesionales calificados y empresarios.",
            tarjetas: [
              {
                imagen: "canada/laboral_canada.jpeg",
                titulo: "Oportunidades Laborales",
                descripcion:
                  "El mercado laboral canadiense es dinámico y en crecimiento, con una demanda significativa en diversos sectores.",
              },
              {
                imagen: "canada/inmigracion_canada.png",
                titulo: "Programas de Inmigración",
                descripcion:
                  "Canadá tiene varios programas de inmigración que facilitan la residencia permanente para trabajadores calificados y emprendedores.",
              },
              {
                imagen: "canada/emprendedores_canada.png",
                titulo: "Visa para Emprendedores",
                descripcion:
                  "El programa de visa para emprendedores apoya a aquellos que desean iniciar un negocio en Canadá.",
              },
            ],
          },
          {
          ...
          },
          {
            titulo: "Requisitos de Visa 2024",
            descripcion:
              "Antes de viajar a Canadá, asegúrate de cumplir con todos los requisitos de visa y documentación necesaria para tu viaje.",
            lista: [
          ...
          },
          {
            ...
            subsecciones: [
              ...
              },
              {
                ...
                items: [
                  {
                    text: "1. Formulario de Solicitud Completo: Dependiendo del tipo de visa, se debe completar el formulario correspondiente.",
                    subitems: [
                      {
                        title: "Para una visa de visitante:",
                        text: "Formulario IMM 5257.",
                      },
                      {
                        title: "Para una visa de estudio:",
                        text: "Formulario IMM 1294.",
                      },
                      {
                        title: "Para una visa de trabajo:",
                        text: "Formulario IMM 1295.",
                      },
                    ],
                  },
                  {
    ...
    australia: {
      first_section: {
        introduccion:
          "La mayoría de los viajeros necesitan una visa para ingresar a Australia. A continuación se detallan los requisitos de visa para diferentes regiones del mundo.",
        secciones: [
          {
            titulo: "América del Norte",
            descripcion:
              "Los viajeros de América del Norte requieren una visa para ingresar a Australia.",
            lista: [
          ...
          },
          {
            ...
            descripcion:
              "Todos los países de América Central y el Caribe requieren una visa para ingresar a Australia.",
            lista: [
              "Antigua y Barbuda",
              "Bahamas",
              "Barbados",
          ...
          },
          {
            ...
            descripcion:
              "Todos los países de América del Sur requieren una visa para ingresar a Australia.",
            lista: [
              "Argentina",
              "Bolivia",
              "Brasil",
          ...
          },
          {
            titulo: "Europa",
            descripcion:
              "Los ciudadanos de muchos países europeos pueden solicitar la visa eVisitor para ingresar a Australia.",
            lista: [
              "Andorra",
              "Austria",
              "Bélgica",
          ...
          },
          {
            titulo: "Oceanía",
            descripcion:
              "La mayoría de los países en Oceanía requieren una visa, excepto los ciudadanos de Nueva Zelanda.",
            lista: [
              "Fiyi",
              "Kiribati",
              "Islas Marshall",
          ...
          },
          {
            ...
            descripcion:
              "Todos los países del Medio Oriente requieren una visa para ingresar a Australia.",
            lista: [
              "Bahréin",
              "Irán",
              "Irak",
        ...
        resumen:
          "Para obtener más información detallada y solicitar una visa, los viajeros deben consultar el sitio web del Departamento de Asuntos Internos del Gobierno de Australia. Este sitio proporciona detalles completos sobre los tipos de visas disponibles, los criterios de elegibilidad y el proceso de solicitud",
      },
    },
    englad: {
      first_section: {
        introduccion:
          "A continuación se presenta un listado de los países cuyos ciudadanos requieren visa para ingresar al Reino Unido:",
        secciones: [
          {
            titulo: "África",
            descripcion:
              "Todos los países en África requieren una visa para ingresar al Reino Unido.",
            lista: [
              "Argelia",
              "Angola",
              "Benín",
          ...
          },
          {
            titulo: "Asia",
            descripcion:
              "Todos los países en Asia requieren una visa para ingresar al Reino Unido.",
            lista: [
              "Afganistán",
              "Armenia",
              "Azerbaiyán",
          ...
          },
          {
            titulo: "Europa",
            descripcion:
              "Algunos países en Europa requieren una visa para ingresar al Reino Unido.",
            lista: [
              "Albania",
              "Bielorrusia",
          ...
          },
          {
            titulo: "América",
            descripcion:
              "Todos los países en América requieren una visa para ingresar al Reino Unido.",
            lista: [
              "Antigua y Barbuda",
              "Argentina",
              "Bahamas",
          ...
          },
          {
            titulo: "Oceanía",
            descripcion:
              "La mayoría de los países en Oceanía requieren una visa, excepto los ciudadanos de Australia y Nueva Zelanda.",
            lista: [
              "Fiyi",
              "Kiribati",
              "Islas Marshall",
        ...
        resumen:
          "Para obtener más información detallada y solicitar una visa, los viajeros deben consultar el sitio web del Gobierno del Reino Unido. Este sitio proporciona detalles completos sobre los tipos de visas disponibles, los criterios de elegibilidad y el proceso de solicitud.",
      },
      second_section: {
        titulo: "Requisitos Generales",
        descripcion: [
    ...
    india: {
      first_section: {
        introduccion:
          "Para ingresar a la India, la mayoría de los visitantes necesitan obtener una visa, ya sea antes de su llegada o a través de un sistema de visa electrónica (e-Visa). Los ciudadanos de todos los países, excepto Bután y Nepal, necesitan una visa para ingresar a la India. Aquí tienes un resumen de los requisitos según el tipo de visa y el país de origen:",
        secciones: [
          {
            titulo: "Visa a la llegada o e-Visa",
            descripcion:
              "India ofrece visas electrónicas (e-Visas) para ciudadanos de muchos países. Los visitantes pueden solicitar una e-Visa en línea antes de su viaje y recibir la aprobación por correo electrónico, lo cual les permite ingresar al país a través de ciertos aeropuertos y puertos marítimos.",
          },
          {
            titulo: "Visa previa a la llegada",
            descripcion:
              "Algunos visitantes deben obtener una visa antes de su llegada, solicitándola en una misión diplomática india en su país de origen.",
          },
          {
            titulo: "Exenciones de visa",
            descripcion:
              "Bután y Nepal: Los ciudadanos de estos dos países no necesitan visa para ingresar a la India. Además, pueden vivir y trabajar en India sin límite de tiempo.\nMaldivas: Los ciudadanos de las Maldivas no necesitan visa para visitas de hasta 90 días.",
          },
        ],
      },
      second_section: {
    ...
    guide_section: {
      ...
      popupWithoutLogin: {
        ...
        description:
          "Para descargar o ver el PDF, necesitas estar autenticado.",
        button: "Aceptar",
      },
    ...
    qualification: {
      ...
      approvalMessage2:
        "Todas tus respuestas han sido evaluadas como correctas e incorrectas, lo que determina tu puntaje para la prueba de visa",
      nextStep:
        "Ahora estás listo para dar el siguiente paso hacia la obtención de tu visa. Para continuar, simplemente envía este comprobante al chat de WhatsApp de ",
      whatsappLink: "https://api.whatsapp.com/send/?phone=50370323075",
      whatsappText: "TODOVISA",
      guideMessage:
        "y podrás disfrutar de un descuento del 25% en la asesoría con TODOVISA.",
      ...
      notApprovedMessage2:
        "lo cual indica que no has aprobado el formulario en esta ocasión. Las respuestas correctas e incorrectas se utilizan para cuantificar tu puntaje, determinando si pasas la prueba de visa o no.",
      dontGetDiscouraged:
        "¡No te desanimes! Cada intento es una oportunidad para aprender y mejorar.",
      ...
      interviewMessage:
        "Es esencial recordar que, aunque esta calificación es significativa, no garantiza automáticamente el éxito en la entrevista oficial que forma parte del procedimiento de visa. La entrevista evaluará aspectos adicionales, como la veracidad de la información proporcionada, tu capacidad para comunicarte eficazmente en el idioma requerido, y otros criterios específicos según las regulaciones del país solicitante.",
      ...
      notes: {
        ...
        personalinformation:
          "La puntuación en esta sección es baja. Es crucial que toda la información personal sea precisa y completa. Errores o información incompleta en esta área pueden impactar significativamente en tu puntuación final.",
        familyfinancialties:
          "La puntuación en esta sección es baja. La falta de información detallada o vínculos familiares y financieros débiles pueden afectar negativamente la evaluación de tu solicitud de visa. Asegúrate de proporcionar toda la información relevante y precisa.",
        travelhistory:
          "Tu puntuación en esta sección es baja debido a un historial de viajes limitado. La falta de experiencia en viajes puede influir en la percepción de tu solicitud y en la evaluación de tu capacidad para cumplir con los requisitos de visa.",
        criminalhistory:
          "La puntuación en esta sección es baja. Cualquier problema en tu historial delictivo o un registro limitado puede impactar la evaluación de tu solicitud. Es importante tener en cuenta que irregularidades en este aspecto pueden afectar tu puntuación.",
      },
    },
    payment: {
      ...
      steps: [
        {
          ...
          description:
            "Primero, elige el país para el cual deseas realizar el servicio VIPRO. Puedes seleccionar entre una variedad de opciones que mejor se adapten a tus necesidades.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Al finalizar el pago, recibirás una confirmación de la transacción. Asegúrate de tomar una captura de pantalla o una foto del comprobante para tus registros.",
        },
        {
          title: "Paso 4: Enviar comprobante",
          description:
            "Envía la captura de pantalla o foto del comprobante al WhatsApp de TODOVISA. Una vez que nuestro equipo confirme el pago, podrás proceder a completar el formulario VIPRO sin preocupaciones. También asegúrate de enviar el comprobante al correo electrónico indicado para garantizar una rápida verificación.",
        },
      ],
      finalMessage:
        "¡Listo! Has completado tu pago de manera segura y eficiente con TodoVisa.",
    },
    send_email: {
    ...
    validation_popup: {
      ...
      text_success2:
        "Inicia sesión para disfrutar de los servicios de Todovisa.",
    ...
    confirmpayment: {
      messages: {
        ...
        popupAccessDenied: {
          title: "Acceso Denegado",
          description:
            "No se pudo acceder al formulario. Si el problema persiste, por favor contacta a un administrador de TODOVISA.",
          button: "Aceptar",
        },
      },
      loading: "Cargando",
    ...
    payBtn: {
      ...
      payN1co:
        "Perfecto para pagos con tarjetas Visa y MasterCard. Pagos rápidos y seguros.",
      payAMC:
        "Ideal para pagos con tarjetas American Express. Pagos rápidos y seguros. Puedes ver cómo realizar una compra con América Central",
      paySteps: "aquí",
      button: "Cancelar",
    },
    guidePayment: {
      success: {
        ...
        description:
          "Tu acceso al PDF ha sido aprobado con éxito. Ahora puedes descargar el documento en cualquier momento.",
        button: "Aceptar",
      },
      error: {
        title: "Acceso Denegado",
        description:
          "Hubo un problema al intentar acceder al PDF. Por favor, intenta nuevamente más tarde.",
        button: "Aceptar",
      },
    },
    errorPopupSignIn: {
    ...
    appointment: {
      pageTitle: "Agenda tu cita con nosotros",
      formTitle: "¡Agenda tu cita fácilmente y recibe atención personalizada!",
      fullNameLabel: "Nombre Completo",
      emailLabel: "Correo Electrónico",
      phoneLabel: "Teléfono",
      messageLabel: "Mensaje (Opcional)",
      noAvailableSchedules: "No se encontraron horarios disponibles",
      dateNotAvailable: "Fecha no disponible",
      userInfoTitle: "Informacion del Usuario",
      userName: "Nombre: ",
      userDate: "Fecha: ",
      ...
      userPhone: "Teléfono: ",
      userMessage: "Mensaje: ",
      bookingButton: "Reservar cita",
      alertSuccessMessage:
        "Tu cita ha sido guardada exitosamente. ¡Nos vemos pronto!",
      availableSchedulesHeader: "Horarios Disponibles",
      sendButton: "Enviar",
      loginButton: "Iniciar sesión",
      noMoreAppointmentsTitle: "No puedes agendar más citas",
      noMoreAppointmentsText:
        "Ya tienes dos citas activas, elimina una cita para agregar otra nueva",
      acceptButton: "Aceptar",
      alertSuccessMessage:
        "Tu cita ha sido guardada exitosamente. ¡Nos vemos pronto!",
      noAvailableSchedules: "No se encontraron horarios disponibles",
      deleteAppointmentTitle: "Eliminar cita",
      deleteAppointmentText: "Seguro que quieres eliminar tu cita?",
      deleteAppointmentConfirm: "Borrar",
      deleteAppointmentCancel: "Cancelar",
      requestError: "Error en la solicitud:",
      errorFetchingSchedule: "Ocurrió un error al obtener el horario.",
      errorSavingData: "Ocurrió un error al guardar los datos.",
      reservedAppointments: "Citas reservadas",
      statusPending: "Estado: Pendiente",
      noDataToShow: "No hay datos por mostrar",
      withSession: {
