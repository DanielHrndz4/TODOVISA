...
const portuguese = [
  {
    ...
    about: {
      ...
      description:
        "Bem-vindo à TODOVISA! Somos uma empresa dedicada a abrir portas para inúmeras oportunidades de crescimento, aventura e inovação. Em nossa comunidade, promovemos a criatividade e a realização de sonhos.",
      description02:
        "Nos esforçamos para derrubar barreiras e redefinir o conceito de sucesso. Com paixão e compromisso, guiamos nossos clientes em uma jornada emocionante em direção a um futuro mais brilhante, onde cada passo o aproxima de alcançar todo o seu potencial. Descubra como podemos ajudá-lo a realizar seus sonhos.",
      ...
      countries: {
        usa: {
          name: "Estados Unidos",
          description:
            "Um país da América do Norte conhecido por sua diversidade cultural, economia poderosa e liderança global em política e tecnologia.",
        ...
        canada: {
          name: "Canadá",
          description:
            "Um país da América do Norte famoso por suas vastas paisagens naturais, multiculturalismo e alta qualidade de vida.",
        ...
        mexico: {
          name: "México",
          description:
            "Um país da América do Norte rico em cultura, história, praias paradisíacas e vida urbana vibrante.",
        ...
        uk: {
          name: "Inglaterra",
          description:
            "Parte do Reino Unido famosa por sua rica história, contribuições para a literatura e ciência, e sua monarquia.",
        ...
        china: {
          name: "China",
          description:
            "Um país asiático conhecido por sua antiga civilização, avanços tecnológicos e econômicos, e maravilhas como a Grande Muralha e a Cidade Proibida.",
        ...
        australia: {
          name: "Austrália",
          description:
            "Um país da Oceania famoso por sua fauna única, paisagens naturais impressionantes como a Grande Barreira de Coral e um estilo de vida relaxado.",
        ...
        india: {
          name: "Índia",
          description:
            "Um país do Sul da Ásia conhecido por sua diversidade cultural, riqueza histórica e espiritualidade, lar de monumentos como o Taj Mahal.",
    ...
    VIPRO: {
      ...
      strong:
        "Ao preencher o formulário, você receberá um desconto de 25% no próximo passo da consultoria de visto com",
    ...
    contact: {
      ...
      info: {
        ...
        schedule:
          "Segunda a sexta: 8:30 - 18:00, Sábados: 9:00 - 17:00, Domingos: Fechado",
      },
    },
    footer: {
      about: "Sobre Nós",
    ...
    popupWithLogin: {
      ...
      description:
        "Selecione uma das opções disponíveis para continuar com o formulário. Oferecemos uma ampla variedade de serviços adaptados às suas necessidades. Reserve um tempo para revisar cada opção e escolha a que melhor se adequa às suas necessidades. <strong>Faça sua seleção e prossiga para o próximo passo!</strong>",
      button: "Continuar",
    ...
    forgot_password: {
      ...
      description:
        "Não se preocupe, isso acontece com todos nós. Digite seu e-mail abaixo para recuperar sua senha",
      email: "E-mail",
    ...
    form: {
      ...
      button2: "Cancelar!",
      warning:
        "Você deve aceitar os termos e condições antes de salvar o formulário.",
    ...
    mexico: {
      first_section: {
        introduccion:
          "Viajar para o México é uma experiência enriquecedora e atraente por várias razões, incluindo sua riqueza cultural, impressionantes pontos turísticos e hospitalidade. Aqui estão algumas das principais razões pelas quais as pessoas escolhem o México como destino de viagem:",
        secciones: [
          {
            titulo: "Riqueza Cultural",
            descripcion:
              "O México é conhecido por seu rico patrimônio cultural, refletido em suas festas, tradições, gastronomia e arte.",
            tarjetas: [
              {
                imagen: "mexico/artes_mexico.jpg",
                titulo: "Artes e Artesanato",
                descripcion:
                  "Celebrações como o Día de los Muertos, reconhecido pela UNESCO como Patrimônio Cultural Imaterial da Humanidade, oferecem aos visitantes uma visão profunda das tradições mexicanas.",
              },
              {
                imagen: "mexico/festividad_mexico.jpg",
                titulo: "Festividades",
                descripcion:
                  "A culinária mexicana, também declarada Patrimônio Cultural Imaterial da Humanidade pela UNESCO, é famosa mundialmente. Pratos como tacos, mole e pozole são apenas alguns exemplos da diversidade culinária do país.",
              },
              {
                imagen: "mexico/gastronomia_mexico.jpg",
                titulo: "Gastronomia",
                descripcion:
                  "O México possui uma rica tradição de artesanato, incluindo têxteis, cerâmicas e joias. Obras de artistas como Frida Kahlo e Diego Rivera também são grandes atrações culturais.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O México abriga inúmeros sítios arqueológicos que atraem turistas de todo o mundo.",
            tarjetas: [
              {
                imagen: "mexico/itza_mexico.jpg",
                titulo: "Chichen Itza",
                descripcion:
                  "Uma das Novas Sete Maravilhas do Mundo, esta antiga cidade maia em Yucatán é famosa pela pirâmide de Kukulkan.",
              },
              {
                imagen: "mexico/teotihuacan_mexico.jpg",
                titulo: "Teotihuacan",
                descripcion:
                  "Localizada perto da Cidade do México, esta antiga cidade pré-hispânica é conhecida por suas massivas Pirâmides do Sol e da Lua.",
              },
              {
                imagen: "mexico/tulum_mexico.jpg",
                titulo: "Tulum",
                descripcion:
                  "Este sítio maia na Riviera Maya combina ruínas históricas com vistas deslumbrantes do Mar do Caribe.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O México oferece uma ampla variedade de destinos turísticos que atendem a diferentes interesses, desde praias até cidades coloniais.",
            tarjetas: [
              {
                imagen: "mexico/cancun.jpg",
                titulo: "Cancún e Riviera Maya",
                descripcion:
                  "Conhecidos por suas praias de areia branca e águas turquesa, são destinos populares para turismo de sol e praia.",
              },
              {
                imagen: "mexico/cdmx.webp",
                titulo: "Cidade do México",
                descripcion:
                  "A capital do país é uma metrópole vibrante com uma rica oferta cultural, incluindo museus, teatros e uma cena gastronômica de primeira classe.",
              },
              {
                imagen: "mexico/vallarta.webp",
                titulo: "Puerto Vallarta",
                descripcion:
                  "Localizada na costa do Pacífico, é famosa por seu calçadão, vida noturna e atividades aquáticas.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O México oferece uma grande diversidade de paisagens naturais, desde desertos até florestas tropicais.",
            tarjetas: [
              {
                imagen: "mexico/barrancas.jpg",
                titulo: "Canyon do Cobre",
                descripcion:
                  "Localizadas no estado de Chihuahua, essas impressionantes formações geológicas são ideais para ecoturismo e atividades ao ar livre.",
              },
              {
                imagen: "mexico/xearet.webp",
                titulo: "Xcaret e Xel-Há",
                descripcion:
                  "Parques ecológicos na Riviera Maya que combinam atrações naturais com atividades culturais e recreativas.",
              },
              {
                imagen: "mexico/sierra_gorda.jpeg",
                titulo: "Sierra Gorda em Querétaro",
                descripcion:
                  "Uma região com biodiversidade excepcional, ideal para ecoturismo e observação da flora e fauna.",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            descripcion:
              "A partir de 2024, cidadãos dos seguintes países latino-americanos precisarão de visto para entrar no México:",
            lista: [
              "Antígua e Barbuda",
              "Brasil",
              "Cuba",
              ...
              items: [
                ...
                },
                {
                  ...
                  subitems: [
                    ...
                    {
                      title:
                        "B. Por Solvência Econômica - Por Emprego, Conta Bancária ou Depósitos a Prazo:",
                      options: [
                        {
                          title: "Por Emprego",
                        ...
                        {
                          title:
                            "Opção 3: Depósitos a Prazo ou Valores e Ações.",
                          details: [
                    ...
                    {
                      title:
                        "D. Por Convite de uma Organização ou Instituição Pública ou Privada:",
                      details: [
                    ...
                    },
                    {
                      ...
                      details: [
                        "Se o solicitante de visto de turismo tiver mais de 65 anos e puder provar de maneira convincente, ao critério da autoridade de imigração, que seu objetivo é visitar o território nacional para turismo, não será necessário provar solvência econômica.",
                      ],
                    },
                    {
                      title: "F. Viajante Frequente:",
                      details: [
                        "Mostrar uma cópia das páginas do passaporte com três vistos válidos ou carimbos de controle de imigração de países não fronteiriços visitados nos últimos 12 meses.",
                      ],
                    },
                    {
    ...
    canada: {
      first_section: {
        introduccion:
          "O Canadá é conhecido pela sua alta qualidade de vida, pelo seu sistema de saúde universal e pelas suas impressionantes paisagens naturais. Oferece oportunidades únicas para estudantes, profissionais e turistas.",
        secciones: [
          {
            titulo: "Oportunidades de Estudo",
            descripcion:
              "O Canadá é um destino popular para estudantes internacionais devido às suas instituições educacionais de alta qualidade e ao seu ambiente multicultural.",
            tarjetas: [
              {
                imagen: "canada/universidad_canada.jpg",
                titulo: "Universidades Prestigiadas",
                descripcion:
                  "O Canadá abriga algumas das universidades mais prestigiadas do mundo, oferecendo uma gama de programas acadêmicos.",
              },
              {
                imagen: "canada/becas_canada.jpg",
                titulo: "Bolsas e Subsídios",
                descripcion:
                  "Existem inúmeras bolsas e subsídios disponíveis para estudantes internacionais, facilitando o acesso ao ensino superior.",
              },
              {
                imagen: "canada/estudiantil_canada.jpeg",
                titulo: "Vida Estudantil",
                descripcion:
                  "A vida estudantil no Canadá é vibrante e diversificada, com inúmeras atividades extracurriculares e oportunidades sociais.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O Canadá é conhecido pela sua alta qualidade de vida, com um sistema de saúde robusto e um ambiente seguro para seus residentes.",
            tarjetas: [
              {
                imagen: "canada/salud_canada.jpg",
                titulo: "Sistema de Saúde",
                descripcion:
                  "O sistema de saúde canadense é um dos melhores do mundo, fornecendo acesso a cuidados médicos universais.",
              },
              {
                imagen: "canada/seguridad_canada.jpg",
                titulo: "Segurança",
                descripcion:
                  "O Canadá é um dos países mais seguros do mundo, com baixos índices de criminalidade e um ambiente pacífico.",
              },
              {
                imagen: "canada/costo_canada.jpg",
                titulo: "Custo de Vida",
                descripcion:
                  "Embora o custo de vida possa variar, o Canadá oferece um bom equilíbrio entre qualidade de vida e despesas econômicas.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O Canadá é famoso pela sua beleza natural, desde as Montanhas Rochosas até os Grandes Lagos e parques nacionais.",
            tarjetas: [
              {
                imagen: "canada/rocosas_canada.jpg",
                titulo: "Montanhas Rochosas",
                descripcion:
                  "Um destino popular para caminhadas, esqui e outras atividades ao ar livre.",
              },
              {
                imagen: "canada/cataratas_canada.jpg",
                titulo: "Cataratas do Niágara",
                descripcion:
                  "Uma das maravilhas naturais mais famosas do mundo, conhecida pela sua impressionante queda d'água.",
              },
              {
                imagen: "canada/parque_canada.jpg",
                titulo: "Parques Nacionais",
                descripcion:
                  "O Canadá possui numerosos parques nacionais oferecendo vistas impressionantes e atividades recreativas.",
              },
            ],
          },
          {
            ...
            descripcion:
              "O Canadá oferece múltiplas oportunidades de trabalho e imigração para profissionais qualificados e empreendedores.",
            tarjetas: [
              {
                imagen: "canada/laboral_canada.jpeg",
                titulo: "Oportunidades de Trabalho",
                descripcion:
                  "O mercado de trabalho canadense é dinâmico e em crescimento, com uma demanda significativa em diversos setores.",
              },
              {
                imagen: "canada/inmigracion_canada.png",
                titulo: "Programas de Imigração",
                descripcion:
                  "O Canadá possui vários programas de imigração que facilitam a residência permanente para trabalhadores qualificados e empreendedores.",
              },
              {
                imagen: "canada/emprendedores_canada.png",
                titulo: "Visto para Empreendedores",
                descripcion:
                  "O programa de visto para empreendedores apoia aqueles que desejam iniciar um negócio no Canadá.",
              },
            ],
          },
          {
          ...
          },
          {
            titulo: "Requisitos de Visto 2024",
            descripcion:
              "Antes de viajar para o Canadá, certifique-se de cumprir todos os requisitos de visto e documentação necessária para a sua viagem.",
            lista: [
                ...
                items: [
                  {
                    ...
                    subitems: [
                      {
                        title: "Para um visto de visitante:",
                        text: "Formulário IMM 5257.",
                      },
                      {
                        title: "Para um visto de estudo:",
                        text: "Formulário IMM 1294.",
                      },
                      {
                        title: "Para um visto de trabalho:",
                        text: "Formulário IMM 1295.",
                      },
                    ],
                  },
                  {
    ...
    australia: {
      first_section: {
        introduccion:
          "A maioria dos viajantes precisa de um visto para entrar na Austrália. Abaixo estão os requisitos de visto para diferentes regiões do mundo.",
        secciones: [
          {
            titulo: "América do Norte",
            descripcion:
              "Viajantes da América do Norte precisam de um visto para entrar na Austrália.",
            lista: [
          ...
          },
          {
            ...
            descripcion:
              "Todos os países da América Central e do Caribe precisam de um visto para entrar na Austrália.",
            lista: [
              "Antígua e Barbuda",
              "Bahamas",
              "Barbados",
          ...
          },
          {
            ...
            descripcion:
              "Todos os países da América do Sul precisam de um visto para entrar na Austrália.",
            lista: [
              "Argentina",
              "Bolívia",
              "Brasil",
          ...
          },
          {
            titulo: "Europa",
            descripcion:
              "Cidadãos de muitos países europeus podem solicitar o visto eVisitor para entrar na Austrália.",
            lista: [
              "Andorra",
              "Áustria",
              "Bélgica",
          ...
          },
          {
            titulo: "Oceania",
            descripcion:
              "A maioria dos países na Oceania precisa de visto, exceto os cidadãos da Nova Zelândia.",
            lista: [
              "Fiji",
              "Kiribati",
              "Ilhas Marshall",
          ...
          },
          {
            ...
            descripcion:
              "Todos os países do Oriente Médio precisam de um visto para entrar na Austrália.",
            lista: [
              "Bahrein",
              "Irã",
              "Iraque",
        ...
        resumen:
          "Para obter mais informações detalhadas e solicitar um visto, os viajantes devem consultar o site do Departamento de Assuntos Internos do Governo da Austrália. Este site fornece detalhes completos sobre os tipos de vistos disponíveis, os critérios de elegibilidade e o processo de solicitação.",
      },
    },
    englad: {
      first_section: {
        introduccion:
          "A seguir, é apresentado uma lista dos países cujos cidadãos precisam de visto para entrar no Reino Unido:",
        secciones: [
          {
            titulo: "África",
            descripcion:
              "Todos os países na África precisam de visto para entrar no Reino Unido.",
            lista: [
              "Argélia",
              "Angola",
              "Benin",
          ...
          },
          {
            titulo: "Ásia",
            descripcion:
              "Todos os países na Ásia precisam de visto para entrar no Reino Unido.",
            lista: [
              "Afeganistão",
              "Armênia",
              "Azerbaijão",
          ...
          },
          {
            titulo: "Europa",
            descripcion:
              "Alguns países na Europa precisam de visto para entrar no Reino Unido.",
            lista: [
              "Albânia",
              "Bielorrússia",
          ...
          },
          {
            titulo: "América",
            descripcion:
              "Todos os países na América precisam de visto para entrar no Reino Unido.",
            lista: [
              "Antígua e Barbuda",
              "Argentina",
              "Bahamas",
          ...
          },
          {
            titulo: "Oceania",
            descripcion:
              "A maioria dos países na Oceania precisa de visto, exceto os cidadãos da Austrália e da Nova Zelândia.",
            lista: [
              "Fiji",
              "Kiribati",
              "Ilhas Marshall",
        ...
        resumen:
          "Para obter mais informações detalhadas e solicitar um visto, os viajantes devem consultar o site do Governo do Reino Unido. Este site fornece detalhes completos sobre os tipos de vistos disponíveis, os critérios de elegibilidade e o processo de solicitação.",
      },
      second_section: {
        titulo: "Requisitos Gerais",
        descripcion: [
    ...
    india: {
      first_section: {
        introduccion:
          "Para entrar na Índia, a maioria dos visitantes precisa obter um visto, seja antes da chegada ou por meio de um sistema de visto eletrônico (e-Visa). Cidadãos de todos os países, exceto Butão e Nepal, precisam de um visto para entrar na Índia. Aqui está um resumo dos requisitos de acordo com o tipo de visto e o país de origem:",
        secciones: [
          {
            titulo: "Visto na chegada ou e-Visa",
            descripcion:
              "A Índia oferece vistos eletrônicos (e-Visas) para cidadãos de muitos países. Os visitantes podem solicitar um e-Visa online antes da viagem e receber a aprovação por e-mail, o que lhes permite entrar no país através de certos aeroportos e portos marítimos.",
          },
          {
            titulo: "Visto prévio à chegada",
            descripcion:
              "Alguns visitantes devem obter um visto antes da chegada, solicitando-o em uma missão diplomática indiana em seu país de origem.",
          },
          {
            titulo: "Isenções de visto",
            descripcion:
              "Butão e Nepal: Cidadãos desses dois países não precisam de visto para entrar na Índia. Além disso, podem viver e trabalhar na Índia sem limite de tempo.\nMaldivas: Cidadãos das Maldivas não precisam de visto para visitas de até 90 dias.",
          },
        ],
      },
      second_section: {
    ...
    qualification: {
      ...
      approvalMessage2:
        "Todas as suas respostas foram avaliadas como corretas e incorretas, o que determina sua pontuação para o teste de visto",
      nextStep:
        "Agora você está pronto para dar o próximo passo para obter seu visto. Para continuar, basta enviar este certificado para o chat do WhatsApp de ",
      whatsappLink: "https://api.whatsapp.com/send/?phone=50370323075",
      whatsappText: "TODOVISA",
      guideMessage:
        " e você aproveitará um desconto de 25% na consultoria com TODOVISA.",
      ...
      notApprovedMessage2:
        "o que indica que você não passou no formulário desta vez. As respostas corretas e incorretas são usadas para quantificar sua pontuação, determinando se você passa no teste de visto ou não.",
      dontGetDiscouraged:
        "Não desanime! Cada tentativa é uma oportunidade para aprender e melhorar.",
      ...
      notes: {
        improvement: "Áreas de melhoria",
        personalinformation:
          "Sua pontuação nesta seção está baixa. É crucial que todas as informações pessoais sejam precisas e completas. Erros ou informações incompletas nesta área podem impactar significativamente sua pontuação final.",
        familyfinancialties:
          "Sua pontuação nesta seção está baixa. A falta de informações detalhadas ou vínculos familiares e financeiros fracos pode afetar negativamente a avaliação de sua solicitação de visto. Certifique-se de fornecer todas as informações relevantes e precisas.",
        travelhistory:
          "Sua pontuação nesta seção está baixa devido a um histórico de viagens limitado. A falta de experiência em viagens pode influenciar a percepção de sua solicitação e a avaliação de sua capacidade para atender aos requisitos do visto.",
        criminalhistory:
          "Sua pontuação nesta seção está baixa. Quaisquer problemas em seu histórico criminal ou um registro limitado podem impactar a avaliação de sua solicitação. É importante observar que irregularidades neste aspecto podem afetar sua pontuação.",
      },
    },
    payment: {
      title:
        "Como realizar seu pagamento seguro com TODOVISA em 4 passos simples?",
      steps: [
        {
          title: "Passo 1: Selecionar o país",
          description:
            "Primeiro, escolha o país para o qual deseja utilizar o serviço VIPRO. Você pode selecionar entre uma variedade de opções que melhor atendem às suas necessidades.",
        },
        {
          title: "Passo 2: Prosseguir para o pagamento",
          description:
            "Depois de selecionar o seu país, prossiga para o pagamento usando seu cartão de débito ou crédito. Aceitamos Visa, Mastercard, American Express e outros cartões principais, garantindo que suas informações estejam protegidas com nossas medidas de segurança avançadas.",
        },
        {
          title: "Passo 3: Confirmação e captura",
          description:
            "Após concluir o pagamento, você receberá uma confirmação da transação. Certifique-se de tirar uma captura de tela ou uma foto do recibo para seus registros.",
        },
        {
          title: "Passo 4: Enviar comprovante",
          description:
            "Envie a captura de tela ou a foto do recibo para o WhatsApp do TODOVISA. Após nossa equipe confirmar o pagamento, você poderá prosseguir para completar o formulário VIPRO sem preocupações. Além disso, certifique-se de enviar o comprovante para o endereço de e-mail indicado para uma verificação rápida.",
        },
      ],
      finalMessage:
        "Pronto! Você completou seu pagamento de forma segura e eficiente com o TodoVisa.",
    },
    send_email: {
    ...
    verification_otp: {
      ...
      resend_email_success:
        "Link de redefinição de senha foi enviado para seu e-mail.",
    ...
    confirmpayment: {
      messages: {
        errorTokenValidation: "Ocorreu um erro ao validar o token.",
        errorFormSubmission: "Ocorreu um erro ao enviar o formulário.",
        popupAccessDenied: {
          title: "Acesso Negado",
          description:
            "Não foi possível acessar o formulário. Se o problema persistir, por favor entre em contato com um administrador da TODOVISA.",
          button: "Aceitar",
        },
      },
      loading: "Carregando",
    ...
    payBtn: {
      ...
      payN1co:
        "Perfeito para pagamentos com cartões Visa e MasterCard. Pagamentos rápidos e seguros.",
      payAMC:
        "Ideal para pagamentos com cartões American Express. Pagamentos rápidos e seguros. Você pode ver como realizar uma compra com a América Central",
      paySteps: "aqui",
      button: "Cancelar",
    },
    guidePayment: {
      success: {
        ...
        description:
          "Seu acesso ao PDF foi aprovado com sucesso. Agora você pode baixar o documento a qualquer momento.",
        button: "Aceitar",
      },
      error: {
        title: "Acesso Negado",
        description:
          "Houve um problema ao tentar acessar o PDF. Por favor, tente novamente mais tarde.",
        button: "Aceitar",
      },
    },
    errorPopupSignIn: {
    ...
    appointment: {
      pageTitle: "Agende seu atendimento conosco",
      formTitle:
        "Agende facilmente seu atendimento e receba uma atenção personalizada!",
      fullNameLabel: "Nome Completo",
      emailLabel: "Endereço de Email",
      phoneLabel: "Telefone",
      messageLabel: "Mensagem (Opcional)",
      noAvailableSchedules: "Nenhum horário disponível encontrado",
      ...
      bookingButton: "Reservar Atendimento",
      alertSuccessMessage: "Seu atendimento foi salvo com sucesso. Até breve!",
      availableSchedulesHeader: "Horários Disponíveis",
      sendButton: "Enviar",
      loginButton: "Iniciar Sessão",
      noMoreAppointmentsTitle: "Você não pode agendar mais compromissos",
      noMoreAppointmentsText:
        "Você já tem dois compromissos ativos. Por favor, exclua um para adicionar um novo",
      acceptButton: "Aceitar",
      alertSuccessMessage: "Seu compromisso foi salvo com sucesso. Até breve!",
      noAvailableSchedules: "Nenhorários disponíveis encontrados",
      deleteAppointmentTitle: "Excluir compromisso",
      deleteAppointmentText:
        "Tem certeza de que deseja excluir seu compromisso?",
      deleteAppointmentConfirm: "Excluir",
      deleteAppointmentCancel: "Cancelar",
      requestError: "Erro na solicitação:",
      errorFetchingSchedule: "Ocorreu um erro ao buscar o horário.",
      errorSavingData: "Ocorreu um erro ao salvar os dados.",
      reservedAppointments: "Citas reservadas",
      statusPending: "Estado: Pendente",
      noDataToShow: "Não há dados para mostrar",
      withSession: {
        title: "Confirmar sua Cita com a Todovisa",
        paragraph: [
          "Tem certeza de que deseja salvar sua cita? Uma vez confirmada, você precisará comparecer na data e hora selecionadas.",
          "Se precisar cancelar sua cita, por favor, entre em contato com um assessor da Todovisa para auxiliar no processo de cancelamento. Certifique-se de fazer isso com a maior antecedência possível para evitar transtornos.",
        ],
      },
      withoutSession: {
        title: "Faça login para agendar sua cita com a TODOVISA",
        paragraph: [
          "Para agendar sua cita com a Todovisa, por favor, faça login em sua conta. Se ainda não tiver uma conta, você pode criar uma facilmente.",
          "Depois de fazer login, você poderá escolher a data e a hora que melhor lhe convier para sua cita. Certifique-se de ter todas as informações necessárias em mãos para completar o processo de reserva sem problemas.",
        ],
      },
    },
  },
