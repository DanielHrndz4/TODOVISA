...
export default function Qualification() {
  ...
  const handleDownloadPDF = () => {
    ...
    // Temporalmente ocultar el botón durante la generación del PDF
    const button = document.querySelector(".download-button");
    const padding = document.querySelector("#paddingButton");
    if (button) {
      button.style.display = "none";
      padding.style.paddingTop = "20rem";
    }
    ...
    html2canvas(input).then((canvas) => {
      ...
      if (button) {
        ...
        padding.style.paddingTop = "10rem";
      }
    });
  };
      ...
      >
        <div className="w-[80%] m-auto pt-10 pb-20">
              ...
              <table className="w-full border-collapse rounded-md">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border px-4 py-2">{userResponse.country}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="border px-4 py-2 font-bold">Teléfono:</td>
                    <td className="border px-4 py-2" colSpan="3">
                      {userResponse.tel}
                    </td>
                  </tr>
          ...
          <div className="w-full flex flex-row gap-2 m-auto">
            ...
            <div className="flex flex-col w-full pt-20 pb-12">
              <PieG correct={correctCountAFF} incorrect={incorrectCountAFF} />
              ...
              <div className="text-justify flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-3">
                  <p>
                    ...
                    Es fundamental tener en cuenta esta variabilidad al evaluar
                    tus respuestas, ya que cada una contribuye de manera única
                    al puntaje global. Esta calificación final es un criterio
                    importante para determinar si cumples con los requisitos
                  ...
                  <p>
                    ...
                    visa. La entrevista evaluará aspectos adicionales, como la
                    veracidad de la información proporcionada, tu capacidad para
                    comunicarte eficazmente en el idioma requerido, y otros
                    criterios específicos según las regulaciones del país
                    solicitante.
                  </p>
                </div>
              </div>
