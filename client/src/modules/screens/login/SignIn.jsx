...
export default function Login() {
  ...
  useEffect(() => {
    setSignInText(
      isActiveBtn
        ? signinText.button.loading_text
        : signinText.button.default_text
    );
  }, [isActiveBtn]);
    ...
    return (
      <>
        <div className="flex flex-col py-16 w-full lg:w-[50%]">
          <Link
            to="/"
            className="flex justify-center items-center py-4 lg:py-4"
          >
            <Typography
              as="a"
              href="#"
        ...
        <div className="bg-white py-16 px-20 rounded-lg shadow flex flex-col gap-6">
          ...
          <Link to="/">
            <div className="flex flex-row">
              <Button className="bg-TVred shadowbtn py-6 px4 m-auto flex justify-center items-center">
                {withSession.button}
              </Button>
            </div>
          </Link>
