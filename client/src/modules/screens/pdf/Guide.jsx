                ...
                <div className="relative">
                    ...
                    <div className="w-full h-full pt-[120px] lg:pt-[130px] bg-[#fafafa]">
                        <div className="flex flex-col justify-center items-center">
                            <p className="py-1 my-3 px-4 rounded-md bg-gray-400 font-medium"><strong>1</strong>/32</p>
                        <img src="./img/pdf/portada.jpg" alt="" className="max-w-[816px] w-full max-h-[1056px] h-full mb-3" />
                        <img src="./img/pdf/page.jpg" alt="" className="max-w-[816px] w-full max-h-[1056px] h-full my-3" />
                        </div>
                    </div>
                </div>
            ) : navigateTo('/')}
