                ...
                <form className="mt-6 mb-2 w-80 max-w-screen-lg sm:w-96">
                  <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <input className="appearance-none block w-full bg-transparent shadow text-white border focus:border-black border-white rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-trasnparent" id="grid-first-name" type="text" placeholder="Jane" name="firstName" value={formData.firstName} onChange={handleChange} />
                    ...
                    <div className="w-full md:w-1/2 px-3">
                      ...
                      <input className="appearance-none block w-full bg-transparent shadow text-white border focus:border-black border-white rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-trasnparent" id="grid-last-name" type="text" placeholder="Jane" name="lastName" value={formData.lastName} onChange={handleChange} />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                      ...
                      <input className="appearance-none block w-full bg-transparent shadow text-white border focus:border-black border-white rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-trasnparent" id="grid-repeatpassword" type="password" placeholder="******" name="repeatpassword" value={formData.repeatpassword} onChange={handleChange} />
                      {/* <p className="text-gray-600 text-xs italic">Make it as long and as crazy as you'd like</p> */}
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-2">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <input className="appearance-none block w-full bg-transparent shadow text-white border focus:border-black border-white rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-trasnparent" id="grid-country" type="text" placeholder="El Salvador" name="country" value={formData.country} onChange={handleChange} />
                    </div>
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <input className="appearance-none block w-full bg-transparent shadow text-white border focus:border-black border-white rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-trasnparent" id="grid-tel" type="tel" placeholder="+503 00000000" name="tel" value={formData.tel} onChange={handleChange} />
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-row items-center my-8">
                    ...
                    <h1 className="mx-4 [text-shadow:_4px_2px_2px_rgb(0_0_0_/_0.6)] text-white font-medium text-md">O registrate con</h1>
                    <hr className="flex-grow h-0.5 bg-gray-300" />
                  </div>
